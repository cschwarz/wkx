...
function Point(x, y, z, m) {
    ...
    this.x = isNaN(x) ? undefined : x;
    this.y = isNaN(y) ? undefined : y;
    this.z = isNaN(z) ? undefined : z;
    this.m = isNaN(m) ? undefined : m;

    this.hasZ = typeof z !== 'undefined';
    this.hasM = typeof m !== 'undefined';
}
